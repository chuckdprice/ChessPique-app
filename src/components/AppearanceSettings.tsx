...
export default function AppearanceMenu({ value, onChange }: AppearanceSettingsProps) {
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div className="absolute right-0 z-20 mt-2 w-72 rounded-xl border border-rule bg-card p-4 text-ink shadow-lg">
